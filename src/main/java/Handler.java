...
public class Handler {
    ...
    public static void handleRequest(Socket socket) {
        try (
            ...
            handleNotFoundCase(out, path, socket);

            final var filePath = Path.of(".", "public", path);
            final var mimeType = Files.probeContentType(filePath);
            handleClassicCase(path, filePath, out, mimeType, socket);
    ...
    private static void handleNotFoundCase(BufferedOutputStream out, String path, Socket socket) throws IOException {
    ...
    private static void handleClassicCase(String path, Path filePath, BufferedOutputStream out, String mimeType
